package com.kxw.microservice.zuul.apigateway.filter;
...
/**
 * http://www.spring4all.com/article/303
 ...
 * filterOrder：过滤器的执行顺序。当请求在一个阶段中存在多个过滤器时，需要根据该方法返回的值来依次执行。 filterOrder() 方法 数字越大 优先级越低
